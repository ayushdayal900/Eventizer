...
function CreateEvent() {
  ...
  const handleSubmit = (e) => {
    ...
    const newEvent = {
      ...formData,
      createdByUser: true, // Add createdByUser flag
      startDate: new Date(formData.startDate).toLocaleDateString('en-US', { day: '2-digit', month: 'short', year: 'numeric' }),
      endDate: new Date(formData.endDate).toLocaleDateString('en-US', { day: '2-digit', month: 'short', year: 'numeric' }),
      startTime: new Date(formData.startDate).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', hour12: true }),
      endTime: new Date(formData.endDate).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', hour12: true }),
      location: eventMode === 'Online' ? 'Online' : formData.venueName || 'N/A', // Set location
      organizer: formData.organizerName || 'N/A', // Organizer name
      poster, // Poster URL
    };
    ...
    // Navigate to the respective event type page
